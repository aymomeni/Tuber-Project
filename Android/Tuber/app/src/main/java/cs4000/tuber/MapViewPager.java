...
public class MapViewPager extends FrameLayout implements OnMapReadyCallback {
    ...
    // Ali Update:
    private int width_screen = getResources().getDisplayMetrics().widthPixels;
    private int height_screen = getResources().getDisplayMetrics().heightPixels;
            ...
            if (adapter.getCameraPositions(page) != null) {
                for (int i = 0; i < adapter.getCameraPositions(page).size(); i++) {
                    ...
                    if (cp != null) {
                        ...
                        mo.icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_studyhotspot_marker_icon));
    ...
    private void initDefaultPosition() {
        ...
        defaultPosition = CameraUpdateFactory.newLatLngBounds(bounds, width_screen, height_screen, mapOffset);
    }
    ...
    private CameraUpdate getDefaultPagePosition(final MultiAdapter adapter, int page) {
        ...
        return CameraUpdateFactory.newLatLngBounds(bounds, width_screen, height_screen, mapOffset);
    }
